...
python train.py --csv_train /work2/jbibe/datasets/dataset_csvs/reannotation_set_hpc.csv --csv_classes classes.csv --csv_val /work1/jbibe/datasets/dataset_csvs/reannotation_valset_hpc.csv --csv_weight /work1/jbibe/datasets/dataset_csvs/weightset_85.csv --batch_size=16 --depth=50 --flip_mod 4 --rew_start 200 --continue_training trained_models/propitious-lamp-168_3s5v12pj
