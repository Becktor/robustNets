...
def getK():
    return np.array(
        [
            [7.188560e02, 0.000000e00, 6.071928e02],
            [0, 7.188560e02, 1.852157e02],
            [0, 0, 1],
        ]
    )
...
def getLeftImage(i):
    return cv2.imread(
        "E:/DataSets/dataset/2011_10_03_drive_0027_sync/2011_10_03/2011_10_03_drive_0027_sync/image_00/data/{0:010d}.png".format(
            i
        ),
        0,
    )
...
def getRightImage(i):
    return cv2.imread(
        "E:/DataSets/dataset/2011_10_03_drive_0027_sync/2011_10_03/2011_10_03_drive_0027_sync/image_01/data/{0:010d}.png".format(
            i
        ),
        0,
    )
...
def playImageSequence(left_img, right_img, K):
    ...
    for i in range(0, 1400):
        ...
        cv2.putText(
            traj, text, (10, 50), cv2.FONT_HERSHEY_PLAIN, 1, (255, 255, 255), 1, 8
        )
        ...
        vis[:h1, :w1, :3] = traj
        vis[:h2, w1 : w1 + w2, :3] = np.dstack(
            (np.dstack((curImage, curImage)), curImage)
        )
